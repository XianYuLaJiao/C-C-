...
topFrame = Frame()
inputLabel = Label(topFrame, text='7201部队', fg='red', font='微软雅黑 20')
inputLabel.pack(side=LEFT,padx=8, pady=5)

inputVar = StringVar()
inputentry = Entry(topFrame, textvariable = inputVar)
inputentry.pack(side=LEFT,)

inputButton = Button(topFrame, text='kkkkkk', command = tax_calc)
